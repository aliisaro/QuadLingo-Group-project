...
-- Dumping data for table QuadLingo.CORRECTANSWER: ~65 rows (suunnilleen)
...
-- Dumping data for table QuadLingo.FLASHCARD: ~47 rows (suunnilleen)
INSERT INTO `FLASHCARD` (`FlashcardID`, `Term`, `Translation`, `Topic`, `language_code2`) VALUES
	...
	(40, 'La voiture', 'Auto', 'La vie', 'fr'),
	(41, 'La maison', 'Koti', 'La vie', 'fr'),
	(42, 'Les enfants', 'Lapset', 'La vie', 'fr'),
	(43, 'Les toilettes', 'Kylpyhuone', 'La vie', 'fr'),
	(44, 'سيارة', 'Auto', 'حياة', 'ar'),
	(45, 'بيت', 'Koti', 'حياة', 'ar'),
	(46, 'أطفال', 'Koti', 'حياة', 'ar'),
	(47, 'حمام', 'Koti', 'حياة', 'ar');
...
-- Dumping data for table QuadLingo.QUESTION: ~65 rows (suunnilleen)
INSERT INTO `QUESTION` (`QuestionID`, `Question`, `QuizID`) VALUES
	...
	(33, 'How do you say "I am sorry" in Finnish?', 7),
	...
	(54, '芬兰语中的“是”是哪个单词？', 11),
	(55, '芬兰语中的“不”是哪个单词？', 11),
	(56, 'ما هي الكلمة الفنلندية ل "مرحبا"؟', 12),
	(57, 'ما هي الكلمة الفنلندية التي تعني "شكرا"؟', 12),
	(58, 'ما هي الكلمة الفنلندية التي تعني "آسف"؟', 12),
	(59, 'ما هي الكلمة الفنلندية ل "نعم"؟', 12),
	(60, 'ما هي الكلمة الفنلندية لكلمة "لا"؟', 12),
	(61, 'Quel est le mot finlandais pour "bonjour"?', 13),
	(62, 'Quel est le mot finlandais pour "merci"?', 13),
	(63, 'Quel est le mot finnois pour "désolé" ?', 13),
	(64, 'Quel est le mot finlandais pour "oui"?', 13),
	(65, 'Quel est le mot finlandais pour "non"?', 13);
...
-- Dumping data for table QuadLingo.QUIZ: ~13 rows (suunnilleen)
INSERT INTO `QUIZ` (`QuizID`, `QuizTitle`, `QuizScore`, `language_code`) VALUES
	...
	(11, '基础芬兰语词汇', 5, 'ch'),
	(12, 'المفردات الفنلندية الأساسية', 5, 'ar'),
	(13, 'Vocabulaire finlandais de base', 5, 'fr');
